...
class Config:
    API_ID = int(os.environ.get("API_ID", 13554562))
    API_HASH = os.environ.get("API_HASH", "f018746a92d8e774664bebfb6f28abe5")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "5105540059:AAHbJtVN2FLHJk0vE14_Bm7sAkWA_Y0xDFE")
    DOWNLOAD_LOCATION = "./DOWNLOADS"
    TG_MAX_SIZE = 2040108421
    OWNER_ID = int(os.environ.get("OWNER_ID", 853523454))
